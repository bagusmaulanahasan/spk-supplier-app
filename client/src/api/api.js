...
export const updateCriteriaValue = (id, data) => API.put(`/criteria-values/${id}`, data);
...
export const getSupplierCriteriaValues = () => API.get('/supplier-criteria-values');
export const createSupplierCriteriaValue = (data) => API.post('/supplier-criteria-values', data);
export const updateSupplierCriteriaValue = (id, data) => API.put(`/supplier-criteria-values/${id}`, data);
export const deleteSupplierCriteriaValue = (id) => API.delete(`/supplier-criteria-values/${id}`);
